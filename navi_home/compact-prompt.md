...
- NEVER include API keys, tokens, passwords, secrets, credentials — replace with [REDACTED]

**Required Output Structure:**

<current_focus>
[What we're working on now — copy the user's most recent request verbatim]
</current_focus>
