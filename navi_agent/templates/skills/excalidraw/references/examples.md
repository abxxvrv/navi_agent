...
A larger diagram with background zones, multiple nodes, and directional arrows showing inputs and outputs.
...
[
  ...
  {"type":"arrow","id":"a1","x":350,"y":225,"width":120,"height":0,"points":[[0,0],[120,0]],"strokeColor":"#1e1e1e","strokeWidth":2,"endArrowhead":"arrow"},
  {"type":"rectangle","id":"cc","x":470,"y":190,"width":160,"height":70,"backgroundColor":"#d0bfff","fillStyle":"solid","roundness":{"type":3},"strokeColor":"#8b5cf6","boundElements":[{"id":"t_cc","type":"text"},{"id":"a1","type":"arrow"},{"id":"a6","type":"arrow"}]},
...
[
  ...
  {"type":"arrow","id":"uLine","x":110,"y":100,"width":0,"height":300,"points":[[0,0],[0,300]],"strokeColor":"#b0b0b0","strokeWidth":1,"strokeStyle":"dashed","endArrowhead":null},
  ...
  {"type":"arrow","id":"aLine","x":280,"y":100,"width":0,"height":300,"points":[[0,0],[0,300]],"strokeColor":"#b0b0b0","strokeWidth":1,"strokeStyle":"dashed","endArrowhead":null},
  ...
  {"type":"arrow","id":"sLine","x":485,"y":100,"width":0,"height":300,"points":[[0,0],[0,300]],"strokeColor":"#b0b0b0","strokeWidth":1,"strokeStyle":"dashed","endArrowhead":null},
  {"type":"arrow","id":"m1","x":110,"y":150,"width":170,"height":0,"points":[[0,0],[170,0]],"strokeColor":"#1e1e1e","strokeWidth":2,"endArrowhead":"arrow"},
  {"type":"arrow","id":"m2","x":280,"y":200,"width":205,"height":0,"points":[[0,0],[205,0]],"strokeColor":"#8b5cf6","strokeWidth":2,"endArrowhead":"arrow"},
  {"type":"arrow","id":"m3","x":485,"y":260,"width":-205,"height":0,"points":[[0,0],[-205,0]],"strokeColor":"#f59e0b","strokeWidth":2,"endArrowhead":"arrow","strokeStyle":"dashed"},
  {"type":"arrow","id":"m4","x":280,"y":320,"width":-170,"height":0,"points":[[0,0],[-170,0]],"strokeColor":"#8b5cf6","strokeWidth":2,"endArrowhead":"arrow","strokeStyle":"dashed"}
]
```
...
- **Do NOT use label property** -- this is the number one mistake. It is NOT part of the Excalidraw file format and will be silently ignored, producing blank shapes with no visible text. Always use container binding (containerId + boundElements) as shown in the examples above.
- **Every bound text needs both sides linked** -- the shape needs boundElements listing the text id AND the text needs containerId pointing to the shape. If either is missing, the binding will not work.
...
- **Elements overlap when y-coordinates are close** -- always check that text, boxes, and labels do not stack on top of each other.
...
- **Draw decorations LAST** -- cute illustrations (sun, stars, icons) should appear at the end of the array so they are drawn on top.
