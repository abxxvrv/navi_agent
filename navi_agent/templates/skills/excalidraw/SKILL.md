...
4. **Upload and send the link** — run `scripts/upload.py` to get a shareable URL, then send that URL to the user. Never just send a file path.
...
```bash
python C:\Users\29924\.navi\skills\excalidraw\scripts\upload.py <path-to-file.excalidraw>
```
