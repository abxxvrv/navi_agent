...
- **Git Bash on Windows**: Library IDs with `/` are interpreted as paths. Use double slash: `ctx7 docs "//facebook/react" "hooks"` instead of `ctx7 docs "/facebook/react" "hooks"`
